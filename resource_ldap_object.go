...
// 		return err
// 	}
// 	log.Printf("[DEBUG] resourceLDAPObjectCreate - creating a new object under %q", d.Get("dn").(string))
...
// 	if err != nil {
// 		log.Printf("[ERROR] resourceLDAPObjectCreate - error adding object %q to LDAP server: %v", object.DN, err)
// 		return err
// 	}

// 	log.Printf("[DEBUG] resourceLDAPObjectCreate - object %q added to LDAP server", object.DN)
